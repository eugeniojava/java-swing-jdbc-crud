...
public class ProductFormView extends AbstractFormView<Product> {
    public ProductFormView(JFrame parent, AbstractDao<Product> dao, AbstractView<Product> view, String action,
                           Product product) {
